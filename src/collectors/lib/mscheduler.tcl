...
#
#     proc npstats::mscheduler::match_timespec <spec>
#
...
#
package provide npstats::mscheduler 1.0;
namespace eval npstats::mscheduler {
...
proc npstats::mscheduler::match_minutespec {code} {
...
proc npstats::mscheduler::match_hourspec {hourspec} {
...
proc npstats::mscheduler::match_dayspec {dayspec} {
...
proc npstats::mscheduler::match_wdayspec {wdayspec} {
